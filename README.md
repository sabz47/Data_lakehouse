...
The system ensures:
Reliable data ingestion, Data quality and consistency, Scalable transformations, Analytics-ready datasets for BI tools
------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
CRM systems, ERP systems, Transactional databases, CSV / external data files
...
Data cleaning, Data type casting,Data standardization, Data validation
The goal of this layer is to produce reliable dataset with high quality that can be safely used for business analysis.
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Business intelligence dashboards, Data analytics, Reporting tools such as Power BI or Tableau

Data in this layer is typically modeled using dimensional modeling techniques such as fact and dimension tables followed by star schema.
